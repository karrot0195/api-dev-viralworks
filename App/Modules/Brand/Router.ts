        ...
        this.routes = [
            {
                ...
                group: [
                    { path: '/test/{id}', method: HTTP.Put, handler: this.testController.getTest },
                    { path: '/test', method: HTTP.Get, handler: this.testController.getTest },
                    { path: '/test', method: HTTP.Post, handler: this.testController.getTest }
                ]
            }
        ];
    }
