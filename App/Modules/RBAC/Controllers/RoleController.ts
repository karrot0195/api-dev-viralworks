...
export class RoleController {
    ...
    public readonly getPaths: IHandler = {
        method: async (req: Request, res: Response) => {
            return res.status(200).json(this.service.routePaths);
        },
        document: {
    ...
    public readonly createPermission: IHandler = {
        ...
        document: {
            tags: ['Permission Manager'],
            responses: {
                201: 'Permission was created successfully',
                403: 'Forbidden',
                400: 'Bad Request'
            },
            security: true,
    ...
    public readonly updatePermission: IHandler = {
        ...
        document: {
            tags: ['Permission Manager'],
            responses: {
                200: 'Permission was updated successfully',
                403: 'Forbidden',
                400: 'Bad Request'
            },
            security: true,
            summary: 'Update a permission by specified ID'
        }
    };
    ...
    public readonly getPermissions: IHandler = {
        ...
        document: {
            ...
            security: true,
            summary: 'Get access control permissions by conditions'
        }
    };
    ...
    public readonly getPermissionById: IHandler = {
        ...
        document: {
            ...
            security: true,
            summary: 'Get access control permissions by id'
        }
    };
    ...
    public readonly searchPermissions: IHandler = {
        ...
        document: {
            ...
            security: true,
            summary: 'Search access control permissions'
        }
    };
    ...
    public readonly getRoles: IHandler = {
        ...
        validation: {
            query: {
                sort: {
                    type: DataType.String,
                    description: 'List of fields that wil be sorted. (example: roles|asc,parent_id|desc )',
                    pattern: RE.checkSortArrayString.source
                },
                page: {
                    type: DataType.String,
        ...
        validation: {
            ...
            body: {
                ...
                properties: {
                    ...
                    parent_id: {
                        type: DataType.String,
                        pattern: RE.checkMongoIdAllowEmpty.source
                    },
                    permissions: {
                        type: DataType.Array,
                        items: {
    ...
    public readonly setPermissions: IHandler = {
    ...
    public readonly deleteRoleById: IHandler = {
        method: async (req: Request, res: Response) => {
            let data = await this.service.deleteRoleById(req.params.id);
    ...
    public readonly updateRBAC: IHandler = {
        method: async (req: Request, res: Response) => {
            await this.rbac.load();
            return res.status(200).json({ 'reload-rbac': 'OK' });
        },
        document: {
            tags: ['Internal RBAC Manager'],
            summary: 'Update RBAC'
        }
    };
